...
entry_seed = [
  ...
  #   emoji: "Neutral" },
  # { user_id: User.first.id,
  #   start_entry: DateTime.new(2019,6,11,10,10,10),
  #   created_at: DateTime.new(2019,6,11,10,20,45),
  #   location: "Rome, Italy",
  ...
  #   start_entry: DateTime.new(2019,6,12,18,44,45),
  #   created_at: DateTime.new(2019,6,12,18,50,45),
  ...
  #   emoji: "Happy" },
  # { user_id: User.second.id,
  #   start_entry: DateTime.new(2019,6,13,19,44,45),
  #   created_at: DateTime.new(2019,6,13,19,46,45),
  ...
  #   emoji: "Neutral" },
  # { user_id: User.second.id,
  #   start_entry: DateTime.new(2019,6,15,8,44,45),
  #   created_at: DateTime.new(2019,6,15,8,48,45),
  ...
  #   start_entry: DateTime.new(2019,8,5,18,44,45),
  #   created_at: DateTime.new(2019,8,5,18,50,45),
  ...
  #   emoji: "Angry" },
  # { user_id: User.third.id,
  #   start_entry: DateTime.new(2019,8,10,18,30,45),
  #   created_at: DateTime.new(2019,8,10,18,32,45),
  ...
  #   emoji: "Happy" },
  # { user_id: User.third.id,
  #   start_entry: DateTime.new(2019,8,13,18,44,45),
  #   created_at: DateTime.new(2019,8,13,18,44,45),
  ...
  #   emoji: "Neutral" },
  # { user_id: User.third.id,
  #   start_entry: DateTime.new(2019,8,14,10,44,45),
  #   created_at: DateTime.new(2019,8,14,10,44,45),
  ...
  # { user_id: User.third.id,
  #   start_entry: DateTime.new(2019,8,14,10,44,45),
  #   created_at: DateTime.new(2019,8,14,10,55,45),
  ...
  #   emoji: "Neutral" },
  # { user_id: User.third.id,
  #   start_entry: DateTime.new(2019,8,15,12,45,45),
  #   created_at: DateTime.new(2019,8,15,12,47,45),
  ...
  #   emoji: "Happy" },
  # { user_id: User.third.id,
  #   start_entry: DateTime.new(2019,8,16,8,46,45),
  #   created_at: DateTime.new(2019,8,16,8,48,45),
